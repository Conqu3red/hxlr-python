...
class hxlr_engine_Grid:
    ...
    def __init__(self):
        self.subTypeCount = [0,0,0] # modified!
        self.lineIDCount = 0
        self.lineCount = 0
...
class hxlr_math_geom_Point:
    ...
    def dot(self, other):
        ...
        if not isinstance(other, hxlr_math_geom_Point):
            raise TypeError('Can only take dot product of two hxlr_math_geom_Point objects')
    ...
    def __sub__(self, other):
        """Vector subtraction."""
        return hxlr_math_geom_Point(self.x - other.x, self.y - other.y)
    ...
    def __mul__(self, scalar):
        ...
        if isinstance(scalar, int) or isinstance(scalar, float):
            return hxlr_math_geom_Point(self.x*scalar, self.y*scalar)
        raise NotImplementedError('Can only multiply hxlr_math_geom_Point by a scalar')
